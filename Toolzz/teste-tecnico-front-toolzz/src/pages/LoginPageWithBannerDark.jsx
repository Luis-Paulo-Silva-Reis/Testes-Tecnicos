import "../styles/LoginPageWithBannerDark.css";
...
import TzLogoDark from "../assets/icons/TZ-LogoForDarkVersion.svg";
...
function LoginPageWithBannerDark() {
  ...
  return (
    <>
      <div className="LoginPageWithBanner-container-darkMode">
        ...
        <div className="container-master">
          <div className="LoginPageWithBanner-form">
            ...
            <div className="LoginPageWithBanner-wellcome-darkMode">
              <h2>Boas-vindas!</h2>

              <h5>Entre utilizando uma das opções abaixo</h5>
            </div>

            <div className="LoginPageWithBanner-social-login-darkMode">
              <ButtonWithHover
                defaultImage={tz}
                hoverImage={tzHover}
                href="#"
            ...
            <form
              ...
              className="LoginPageWithBanner-form-theForm-darkMode"
            >
              <div>
...
export default LoginPageWithBannerDark;
